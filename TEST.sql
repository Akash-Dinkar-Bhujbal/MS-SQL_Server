...
CREATE TABLE SALES(salesman_id  INT, name VARCHAR(20),city VARCHAR(20), commission INT);

INSERT INTO SALES VALUES(5001,'James Hoog','New York', 15)
INSERT INTO SALES VALUES(5002,'Nail Knite', 'Paris', 13)
INSERT INTO SALES VALUES(5005 , 'Pit Alex','London',11)
INSERT INTO SALES VALUES(5006 , 'Navin', 'Paris', 14)
INSERT INTO SALES VALUES(5007 , 'Paul Adam','Paris',13)
INSERT INTO SALES VALUES(5003 ,'Lauson Hen','San Jose', 12)
DROP TABLE SALES
...
CREATE TABLE TEACHER(TEACHERID INT, TEACHERNAME VARCHAR(20))
...
CREATE TABLE STUDENT (STUDENTID INT,  STUDNAME VARCHAR(20), TEACHERID INT)
...
CREATE TABLE EMP (EMP_IDNO INT, EMP_FNAME  VARCHAR(20), EMP_LNAME VARCHAR(20),EMP_DEPT INT)
...
EXEC INSERT_EMP 103, 'SHUBHAM', 'BADGUJAR', 300
SELECT * FROM EMP
...
INSERT INTO EMP VALUES (201,'ASHISH','KADAM',300)

INSERT INTO EMP VALUES (202,'','',300)

INSERT INTO EMP VALUES (203,NULL,NULL,300)
